...
def visualize_detection_results(result_dict,
  ...
  Args:
    result_dict: a dictionary holding groundtruth and detection
      faster_rcnn_data corresponding to each image being evaluated.  The following keys
      are required:
    ...
    try:
      for batch in range(int(num_batches)):
        ...
        for evaluator in evaluators:
          # TODO(b/65130867): Use image_id tensor once we fix the input faster_rcnn_data
