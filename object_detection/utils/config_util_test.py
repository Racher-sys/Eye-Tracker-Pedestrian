...
class ConfigUtilTest(tf.test.TestCase):
  ...
  def testNewTrainInputPath(self):
    ...
    original_train_path = ["path/to/faster_rcnn_data"]
    new_train_path = "another/path/to/faster_rcnn_data"
    pipeline_config_path = os.path.join(self.get_temp_dir(), "pipeline.config")
  ...
  def testNewTrainInputPathList(self):
    ...
    original_train_path = ["path/to/faster_rcnn_data"]
    new_train_path = ["another/path/to/faster_rcnn_data", "yet/another/path/to/faster_rcnn_data"]
    pipeline_config_path = os.path.join(self.get_temp_dir(), "pipeline.config")
