...
to evaluate on training faster_rcnn_data instead.
...
input_reader_pb2.InputReader file to specify what faster_rcnn_data the model is evaluating
...
flags.DEFINE_boolean('eval_training_data', False,
                     'If training faster_rcnn_data should be evaluated for this job.')
flags.DEFINE_string(
    'checkpoint_dir', '',
