...
# ==============================================================================
r"""Converts faster_rcnn_data from CSV to the OpenImagesDetectionChallengeEvaluator format.
"""
...
def build_groundtruth_boxes_dictionary(data, class_label_map):
  """Builds a groundtruth dictionary from groundtruth faster_rcnn_data in CSV file.

  Args:
    data: Pandas DataFrame with the groundtruth faster_rcnn_data for a single image.
...
def build_predictions_dictionary(data, class_label_map):
  """Builds a predictions dictionary from predictions faster_rcnn_data in CSV file.

  Args:
    data: Pandas DataFrame with the predictions faster_rcnn_data for a single image.
    class_label_map: Class labelmap from string label name to an integer.
