...
tf.app.flags.DEFINE_string('data_dir', '', 'Location of root directory for the '
                           'faster_rcnn_data. Folder structure is assumed to be:'
...
tf.app.flags.DEFINE_string('label_map_path', 'faster_rcnn_data/kitti_label_map.pbtxt',
...
def convert_kitti_to_tfrecords(data_dir, output_path, classes_to_use,
  ...
  Args:
    data_dir: The full path to the unzipped folder containing the unzipped faster_rcnn_data
    ...
    classes_to_use: List of strings naming the classes for which faster_rcnn_data should be
