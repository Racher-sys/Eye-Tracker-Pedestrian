...
Specifies:
  ...
  TfExampleFields: standard fields for tf-example faster_rcnn_data format (go/tf-example).
"""
...
class InputDataFields(object):
  ...
  Holds the standard faster_rcnn_data field names to use for identifying input tensors. This
