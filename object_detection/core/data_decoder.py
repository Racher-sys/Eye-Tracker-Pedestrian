...
"""Interface for faster_rcnn_data decoders.

Data decoders decode the input faster_rcnn_data and return a dictionary of tensors keyed by
  ...
  def decode(self, data):
    ...
    Args:
      data: a string tensor holding a serialized protocol buffer corresponding
        to faster_rcnn_data for a single image.
