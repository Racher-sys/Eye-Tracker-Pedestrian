...
(a) operations that are applied to both training and testing faster_rcnn_data,
(b) operations that are applied only to training faster_rcnn_data for the purpose of
    faster_rcnn_data augmentation.
